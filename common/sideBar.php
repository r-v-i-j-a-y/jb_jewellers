...
$navList = [
    [
        ...
        'list' => [
            ...
            ['link' => 'purchase-scheme', 'linkName' => 'purchase scheme'],
            ['link' => 'pays-cheme', 'linkName' => 'pay scheme'],
            ['link' => 'view-users', 'linkName' => 'view users'],
            ['link' => 'schemes', 'linkName' => 'schemes'],
            ['link' => 'chit-details', 'linkName' => 'chit details'],
        ]
    ],
    [
        'title' => 'transaction details',
        'list' => [
            ['link' => 'month-wise-payment', 'linkName' => 'month wise payment'],
            ['link' => 'chit-wise-payment', 'linkName' => 'chit wise payment'],
            ['link' => 'pending-payment', 'linkName' => 'pending payment'],
            ['link' => 'change-status', 'linkName' => 'change status'],
            ['link' => 'close-scheme', 'linkName' => 'close scheme'],
        ]
    ]
];
?>

                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-6 bg-white p-5">
                                ...
                                <form id="registerForm">
                                    <div class="mb-3">
                                        <input type="text" name="user_name"  class="form-control rounded-pill"
                                            placeholder="Your Name" autocomplete="user_name">
                                        <p class="m-1 text-danger error-message"></p>
                                    </div>
                                    <div class="mb-3">
                                        <input type="text" name="email" class="form-control rounded-pill"
                                            placeholder="Email Address" onkeypress="return event.charCode != 32" autocomplete="email">
                                        <p class="m-1 text-danger error-message"></p>
                                    </div>
                                    <div class="mb-3">
